        ...
        >
          {
            Array(6).fill('').map((item,index)=>(
              <motion.img
               ...
               src={index%2 === 0 ? assets.sample_img_2 : assets.sample_img_1} alt="" key={index} width={70} className='rounded hover:scale-105 transition-all duration-300 cursor-pointer max-sm:w-10 ' />
            ))}
        </motion.div>
        <motion.p
        initial={{opacity:0}}
